...
// =======================================================================
// #include "Examples/SineLaplace.h" // smooth sol in unitsquares
...
//       for (auto it : V) 
    i=0;
       ...
       {
        cout << *it << " " << errors[i++]<<endl;
      
       }
   
 
    
//    std::vector<char*> Vz = { "First" }; 
   
    cout <<   " " << Database::ParamDB->OUTFILE <<endl;
 
             
    cout << "First test ParMooN 1.0" <<endl;
//   //=========================================================================
