...
// FeUtilities.h   1.1
//
// Purpose:  function definitions for FE computations 
//
...
// ====================================================================
void StreamFunction(FESpace2D *velo,   vector<double> u1, double *u2,
                    FESpace2D *stream, double *psi);

void ComputeVorticityDivergence(FESpace2D *velo, FEFunction2D *u1, FEFunction2D *u2,
                      FESpace2D *vorticity, double *vort, double *div);

// determine L2 and H1 error
void L2H1Errors(int N_Points, double *X, double *Y, double *AbsDetjk, 
                double *Weights, double hK, 
                vector< vector<double> > Der, double **Exact,
...
int GetVelocityAndPressureSpace(TCollection *coll,
                                ...
                                FESpace2D* &velocity_space,
                                FESpace2D* &pressure_space,
...
int ReadGrapeFile(char *name, int N_FEFct, int N_FEVectFct,
                   FEFunction2D **FEFct, TFEVectFunct2D **FEVectFct);
