...
//   std::shared_ptr <ParameterDB> Database::ParamDB;
// TShapeDesc **Database::ShapeDB = NULL;
// TRefDesc   **Database::RefDescDB = NULL;
// TMapper    **Database::MapperDB = NULL;
// TIterator  **Database::IteratorDB = NULL;
  ParameterDB   *Database::ParamDB = NULL;
// TTimeDB    *Database::TimeDB = NULL;

// Methods


void Database::SetDefaultParameters()
{
    
           cout << "SetDefaultParameters " <<endl;
//   char *tmp;
//   ParamDB->OUTFILE = "ParMooN_Default_Outfile";
// 
//   tmp = new char[12];
...
void Database::WriteParamDB(char *ExecutedFile)
{
//   char buf[80];
//   time_t rawtime;
//   struct tm * timeinfo;
...
//   OutFile << "WRITE_AMIRA: " << Param    cout << "First test ParMooN 1.0" <<endl;DB->WRITE_AMIRA << endl;
...
void Database::CheckParameterConsistencyNSE()
{
//   // Newton method
...
//      {
//         Database::ParamDB->SC_NONLIN_MAXIT_SADDLE = 1;
//      }
//      else
//      {
//         Database::ParamDB->SC_NONLIN_MAXIT_SADDLE = 0;
//      }
//      Database::ParamDB->SC_NONLIN_DAMP_FACTOR_SADDLE = 1.0;    
//   }
// 
//   // rotational form
...
//       {
// 	  ParamDB->DISCTYPE = 4;
// 	  Database::ParamDB->TURBULENT_VISCOSITY_TYPE = 0;
// 	  OutPut("DISCTYPE changed to 4 for internal reasons, turbulent viscosity is switched off."<< endl);
//       }	  
//   }
// 
//   if (Database::ParamDB->TURBULENT_VISCOSITY_TYPE==5)
//   {
//       if (!((Database::ParamDB->DISCTYPE == VMS_PROJECTION)||
// 	    (Database::ParamDB->DISCTYPE == VMS_PROJECTION_EXPL)))
//       {
...
//   }
//   
//   if (Database::ParamDB->FLOW_PROBLEM_TYPE == STOKES)  
//     Database::ParamDB->INTERNAL_PROBLEM_LINEAR = 1;
//   if (Database::ParamDB->FLOW_PROBLEM_TYPE == OSEEN)
//   {
//     Database::ParamDB->INTERNAL_PROBLEM_LINEAR = 1;
//     switch (Database::ParamDB->NSTYPE)
//     {
//       case 1: OutPut("Galerkin discretization for Oseen because of NSTYPE "
//   << Database::ParamDB->NSTYPE << endl);
//   Database::ParamDB->DISCTYPE =  1;
//   break;
//       case 14:  OutPut("SUPG/PSPG/grad-div discretization for Oseen because of NSTYPE "
//   << Database::ParamDB->NSTYPE << endl);
//   Database::ParamDB->DISCTYPE =  2;
//   break;
//       default:
//   OutPut("No method for Oseen implemented for NSTYPE " << Database::ParamDB->NSTYPE << endl);
//   exit(4711);
//     }
...
//       Database::ParamDB->SC_NONLIN_DAMP_FACTOR_SADDLE = 1.0;
//       OutPut("Set Database::ParamDB->SC_NONLIN_DAMP_FACTOR_SADDLE to 1.0" << endl);
//     }
//   }
